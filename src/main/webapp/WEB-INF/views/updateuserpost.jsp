...
<div class="max-w-md mx-auto mt-8 bg-white p-8 rounded shadow-lg">
    ...
    <form:form action="/studentregistrationspringjpa/updateuserposted" method="post"  modelAttribute="postdata" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <img src="data:image/jpeg;base64,${post.base64photo}" alt="Student Photo Activities"
